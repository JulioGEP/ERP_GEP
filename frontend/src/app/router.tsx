...
const BulkSessionsImportPage = lazy(() => import('../pages/recursos/BulkSessionsImportPage'));
    ...
    <Suspense fallback={null}>
      <Routes>
        ...
        <Route
          ...
          element={<GuardedRoute path="/recursos/importar_sesiones" element={<BulkSessionsImportPage />} />}
        />
        <Route
