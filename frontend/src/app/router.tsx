...
import type { CamposPipePageProps } from '../pages/recursos/CamposPipePage';
...
const CamposPipePage = lazy(() => import('../pages/recursos/CamposPipePage'));
  ...
  return (
    <Suspense fallback={null}>
      <Routes>
        ...
        />
        <Route
          path="/recursos/campos_pipe"
          element={
            <GuardedRoute
              path="/recursos/campos_pipe"
              roles={['Admin']}
              element={<CamposPipePage {...camposPipePageProps} />}
            />
          }
        />
        <Route
        ...
        <Route path="/reporting/slack" element={<Navigate to="/recursos/slack" replace />} />
        ...
        <Route
          ...
          element={<Navigate to="/usuarios/control_horario_fijos" replace />}
        />
        <Route
          path="/reporting/control_horas_formadores"
          element={<Navigate to="/usuarios/control_horario_discontinuos" replace />}
        />
        <Route
