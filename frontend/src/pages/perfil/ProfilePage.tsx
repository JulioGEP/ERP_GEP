...
export default function ProfilePage() {
  ...
  const vacationCounts: Record<VacationType, number> =
    vacationData?.counts ?? { V: 0, L: 0, A: 0, T: 0, M: 0, H: 0, F: 0, R: 0, P: 0, J: 0, I: 0, N: 0, C: 0, O: 0, Y: 0 };
  ...
  const vacationSummary = [
    ...
    { label: 'Vacaciones año anterior restantes', value: vacationData ? previousYearRemaining : 'Sin definir' },
      ...
      {shouldShowVacations ? (
        <Card className="shadow-sm">
          ...
          <div className="border-top pt-3">
            <h3 className="h6 fw-bold mb-2">{VACATION_REQUEST_SECTION_TITLE}</h3>
            ...
            <Form onSubmit={handleVacationRequest} className="d-grid gap-3">
              ...
              <div className="d-flex flex-wrap justify-content-between align-items-center gap-2">
                ...
                <Button type="submit" disabled={!canRequestVacation} aria-label={VACATION_REQUEST_BUTTON_LABEL}>
