...
import { SessionsAccordionMaterial } from './sessions/SessionsAccordionMaterial';
...
export function BudgetDetailModalMaterial({
  ...
  const handleUploadDocument = async () => {
    ...
    try {
      ...
      console.error('[BudgetDetailModalMaterial] Error al subir documento del presupuesto', error);
  ...
  const updateForm = (field: keyof BudgetFormValuesMaterial, value: string) => {
        ...
        {!isLoading && deal && form && (
          <>
            ...
            <Row className="g-3">
              ...
              <Col md={2}>
                <FieldWithStatus
                  label={<Form.Label className="mb-0">Transporte</Form.Label>}
                  status={renderFollowUpBlock('transporte_val')}
                >
                  <Form.Control
