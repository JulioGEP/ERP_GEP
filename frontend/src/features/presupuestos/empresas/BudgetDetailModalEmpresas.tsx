...
import { SessionsAccordionEmpresas } from './sessions/SessionsAccordionEmpresas';
...
export function BudgetDetailModalEmpresas({
  dealId,
  summary,
  onClose,
  ...
  const updateForm = (field: keyof BudgetFormValuesEmpresas, value: string) => {
