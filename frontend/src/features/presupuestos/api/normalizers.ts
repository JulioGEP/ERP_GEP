...
export function normalizeDealSummary(row: Json): DealSummary {
  ...
  return {
    ...
    created_at: toStringValue(row?.created_at ?? row?.createdAt) ?? null,
...
export function normalizeDealDetail(raw: Json): DealDetail {
  ...
  const normalized: DealDetail = {
    ...
    created_at: toStringValue(raw?.created_at ?? raw?.createdAt) ?? null,
    updated_at: toStringValue(raw?.updated_at ?? raw?.updatedAt) ?? null,
