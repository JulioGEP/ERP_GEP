...
import {
  ...
  type FormacionAbiertaStudentsSyncResult,
...
type FormacionAbiertaSyncResult = FormacionAbiertaStudentsSyncResult & {
...
async function syncFormacionAbiertaSessionsAndStudents(
  ...
  return prisma.$transaction(async (tx: Prisma.TransactionClient) => {
    ...
    const studentsResult = await syncFormacionAbiertaStudentsFromNotes(tx, dealId);
